...
export const sendMessage = async (
    ...
    try {
        const response = await fetch(`${process.env.FASTAPI_URL}/chat/messages/send`, {
            method: 'POST',
            headers: {
...
export const loadMessageHistory = async (
    ...
    try {
        const accessToken = getAccessToken();
        const response = await fetch(`${process.env.FASTAPI_URL}/chat/messages/history/${notebookId}/${chatId}`, {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${accessToken}`,
...
export const createChat = async (
    ...
    try {
        ...
        const response = await fetch(`${process.env.FASTAPI_URL}/chat/create`, {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${accessToken}`
            },
